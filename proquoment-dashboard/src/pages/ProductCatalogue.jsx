...
import { getProducts, insertProduct, updateProduct, deleteProduct } from '../lib/db'
...
export default function ProductCatalogue() {
  ...
  useEffect(() => {
    getProducts().then(data => { if (data) setProductList(data) })
  }, [])
  ...
  const handleSubmit = async (e) => {
    ...
    if (modalMode === 'edit') {
      ...
      const { data } = await insertProduct(payload)
      if (data) {
