...
export default function MyBids() {
  ...
  const [bids, setBids] = useState(STATIC_BIDS)
  const navigate = useNavigate()

  useEffect(() => {
    getBids().then(data => { if (data) setBids(data) })
  }, [])
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <p className="text-xs text-[#9e9e9e] mb-1">My Bid Amount</p>
                    <p className="text-sm font-bold text-[#111111]">{selectedBid.myBid}</p>
                  </div>
                  <div>
                    <p className="text-xs text-[#9e9e9e] mb-1">Delivery Time</p>
